...
#import "UILetterListViewController.h"
#import "UILetterDetailViewController.h"
@interface UILetterListViewController ()
{
    UITableView *table;
    int cellCount;
}
...
@implementation UILetterListViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILetterDetailViewController *ctrl = [[UILetterDetailViewController alloc] init];
    ctrl.title = @"提醒";
