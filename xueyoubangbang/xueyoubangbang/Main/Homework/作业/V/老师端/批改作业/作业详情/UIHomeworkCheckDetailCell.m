...
@interface UIHomeworkCheckDetailCell()<UICollectionViewDataSource,UICollectionViewDelegate,AudioPlayerDelegate>
...
@end
@implementation UIHomeworkCheckDetailCell{
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.picView sd_setImageWithURL:[NSURL URLWithString:UrlResStringForImg([self.checkItemData getPicArray][indexPath.row])] placeholderImage:[UIImage imageNamed:@"loading"] options:SDWebImageProgressiveDownload];
    return cell;
}
