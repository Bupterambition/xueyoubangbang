//
//  UIinterActAskMeViewController.m
//  xueyoubangbang
//
...
@interface UIInterActAskMeViewController ()<UITableViewDataSource,UITableViewDelegate,UIInterActDelegate>
@property (nonatomic, strong) UITableView *table;
@end

@implementation UIInterActAskMeViewController{
