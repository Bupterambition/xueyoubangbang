...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view lableText:(NSString *)lableText animated:(BOOL)animated
{
    MBProgressHUD *hud = [[MBProgressHUD alloc] initWithView:view];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opaque = NO;
        self.backgroundColor = [UIColor clearColor];//[UIColor colorWithWhite:0 alpha:0.3];
...
- (void)layoutSubviews {
    ...
    // by yytong, ios4上崩溃修复
    if(detailsLabel == nil || [detailsLabel.text length] == 0)
    {
